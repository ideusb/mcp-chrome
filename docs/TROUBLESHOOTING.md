...
2. **Check if h88-chrome-mcp-bridge is installed successfully**, ensure it's globally installed
...
`xxx/node_modules/h88-chrome-mcp-bridge/dist/run_host.sh`
...
Or run `h88-chrome-mcp-bridge doctor --fix` to write the current Node path.
