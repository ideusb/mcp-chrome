...
REM Windows: %LOCALAPPDATA%\h88-chrome-mcp-bridge\logs
set "LOG_DIR=%LOCALAPPDATA%\h88-chrome-mcp-bridge\logs"
...
if not defined NODE_EXEC (
    ...
    echo To fix: Set CHROME_MCP_NODE_PATH environment variable or run 'h88-chrome-mcp-bridge doctor --fix' >> "%WRAPPER_LOG%"
    exit /B 1
)
